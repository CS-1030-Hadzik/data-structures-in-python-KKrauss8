...
# the following elements in this order  ---- Ford,Chrysler,Dodge,
# Ram,Jeep,Chevy,GMC` (use single quotes for each element)EX: 
# 'Ford' not "Ford" spelling matters
...
print(cars)
#`problem 16. create a variable called my_array_length with a 
# value of the cars array length (spelling, capitilization, and 
# spaces matter)`
my_array_length = len(cars)
# `problem 17. create a variable called array_string with a 
# value of 'The length of my array is ' (spelling, 
# capitilization, and spaces matter)`
